...
### Spring REST Docs 도입과 시행착오

## 개요

이번 [자율 프로젝트](https://github.com/Mockin-2024)를 진행하며 API 문서 관리 방식에 근본적인 문제를 느꼈습니다.  
바로 구현과 문서가 일치하지 않은 점이었는데요. 처음에는 Postman을 활용해 문서를 관리했지만, 실제 구현과 문서가 자주 어긋나면서 팀원들이 “이 API, 파라미터 바뀌었나요?” 같은 질문을 반복하고 변경 내용을 구두나 메신저로 수시로 전달하는 일이 많았습니다.  
